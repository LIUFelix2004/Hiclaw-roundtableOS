...
<template>
  <main class="competition-view roundtable-view">
    ...
    <PixelRoundtable3D :speeches="orderedSpeeches" :is-running="roundtable.isRunning" :active-round="roundtable.activeRound" />
